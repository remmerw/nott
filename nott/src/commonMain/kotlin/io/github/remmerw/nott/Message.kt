...
internal data class AnnounceRequest(
    ...
    override fun encode(sink: ByteBuffer) {
...
internal fun ByteBuffer.bencodeTid(value: Long) {
...
internal fun ByteBuffer.bencode(address: Address) {
